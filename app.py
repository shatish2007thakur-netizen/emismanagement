    ...
    with center_col:
        ...
        with left_col:
            ...
            <div class="contact-box">
                <b>श्री जनता माध्यमिक विद्यालय</b><br>
                 मायादेवी गाउँपालिका–५, बलुहवा, कपिलवस्तु, <br>
                 लुम्बिनी प्रदेश<br>
            </div>
            """,
                unsafe_allow_html=True,
            ...
            <div class="contact-box">
                ...
                <b>💻Coordinator of Computer Department: Er. Ramesh Singh Yadav</b>
...
# --- RIGHT COLUMN: LOGIN FORM ---
        with right_col:
            st.markdown(
                '<h2 style="color: #FF2B2B !important; font-size: 28px !important; font-weight: 800 !important; text-shadow: 1px 1px 3px #000000; margin-bottom: 15px !important;">Account Login</h2>',
                unsafe_allow_html=True,
            )
